...
namespace IRT.Viewer
{
	class SuperiorMirage : Scene
	{
		...
		public override void Load(List<IDrawable> rays, List<IDrawable> shapes)
		{
			...
			Shape coldAir = new Cuboid(new Vector3(0,-0.15f,0), 8f, 0.5f, 1f, 0, 1f, interact:false);
			...
			space.SpawnCluster(spawnPoint, spawnDirection+new Vector3(0,-0.007f,0), 650f, 650f, 1);
			
			space.SpawnCluster(spawnPoint - new Vector3(0, 0.1f, 0), spawnDirection+new Vector3(0,0.035f,0), 500f, 500f, 1);
